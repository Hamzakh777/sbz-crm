                    ...
                    <li>
                        <div class="language-selector" id="language-selector">
                            <div class="btn-group btn-group-sm">
                                <form action="{{ route('voyager.localisation', ['lang' => 'en']) }}" method="get">
                                    <input type="hidden" id="en" value="en">
                                    <button class="btn btn-primary @if(app()->getLocale() == 'en') active @endif">EN</button>
                                </form>
                                <form action="{{ route('voyager.localisation', ['lang' => 'de']) }}" method="get">
                                    <input type="hidden" id="de" value="de">
                                    <button class="btn btn-primary @if(app()->getLocale() == 'de') active @endif">DE</button>
                                </form>
                            </div>
                        </div>
                    </li>
